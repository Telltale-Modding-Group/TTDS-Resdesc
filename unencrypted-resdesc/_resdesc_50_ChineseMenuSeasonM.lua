local set = {}
set.name = "ChineseMenuSeasonM"
set.setName = "ChineseMenuSeasonM"
set.descriptionFilenameOverride = ""
set.logicalName = "<ChineseMenuSeasonM>"
set.logicalDestination = "<MenuSeasonM>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "ChineseMenuSeasonM Game Data"
...
{
    _currentDirectory .. "WDC_pc_ChineseMenuSeasonM_compressed.ttarch2"
}
