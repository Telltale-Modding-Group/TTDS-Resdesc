local set = {}
set.name = "Traditional_ChineseProjectSeason1"
set.setName = "Traditional_ChineseProjectSeason1"
set.descriptionFilenameOverride = ""
set.logicalName = "<Traditional_ChineseProjectSeason1>"
...
set.gameDataName = "Traditional_ChineseProjectSeason1 Game Data"
