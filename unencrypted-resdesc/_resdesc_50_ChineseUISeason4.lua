local set = {}
set.name = "ChineseUISeason4"
set.setName = "ChineseUISeason4"
set.descriptionFilenameOverride = ""
set.logicalName = "<ChineseUISeason4>"
...
set.gameDataName = "ChineseUISeason4 Game Data"
...
{
    _currentDirectory .. "WDC_pc_ChineseUISeason4_compressed.ttarch2"
}
