local set = {}
set.name = "FrenchMenuSeason1"
set.setName = "FrenchMenuSeason1"
set.descriptionFilenameOverride = ""
set.logicalName = "<FrenchMenuSeason1>"
...
set.gameDataName = "FrenchMenuSeason1 Game Data"
...
{
    _currentDirectory .. "WDC_pc_FrenchMenuSeason1_compressed.ttarch2"
}
