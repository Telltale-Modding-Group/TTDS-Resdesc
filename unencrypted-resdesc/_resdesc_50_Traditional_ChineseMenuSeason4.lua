local set = {}
set.name = "Traditional_ChineseMenuSeason4"
set.setName = "Traditional_ChineseMenuSeason4"
set.descriptionFilenameOverride = ""
set.logicalName = "<Traditional_ChineseMenuSeason4>"
set.logicalDestination = "<MenuSeason4>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "Traditional_ChineseMenuSeason4 Game Data"
