local set = {}
set.name = "ItalianUISeason3"
set.setName = "ItalianUISeason3"
set.descriptionFilenameOverride = ""
set.logicalName = "<ItalianUISeason3>"
set.logicalDestination = "<UISeason3>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "ItalianUISeason3 Game Data"
