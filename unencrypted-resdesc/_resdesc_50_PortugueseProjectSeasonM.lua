local set = {}
set.name = "PortugueseProjectSeasonM"
set.setName = "PortugueseProjectSeasonM"
set.descriptionFilenameOverride = ""
set.logicalName = "<PortugueseProjectSeasonM>"
...
set.gameDataName = "PortugueseProjectSeasonM Game Data"
