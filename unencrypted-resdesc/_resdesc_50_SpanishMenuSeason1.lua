local set = {}
set.name = "SpanishMenuSeason1"
set.setName = "SpanishMenuSeason1"
set.descriptionFilenameOverride = ""
set.logicalName = "<SpanishMenuSeason1>"
set.logicalDestination = "<MenuSeason1>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "SpanishMenuSeason1 Game Data"
...
{
    _currentDirectory .. "WDC_pc_SpanishMenuSeason1_compressed.ttarch2"
}
