local set = {}
set.name = "Traditional_ChineseUISeason4"
set.setName = "Traditional_ChineseUISeason4"
set.descriptionFilenameOverride = ""
set.logicalName = "<Traditional_ChineseUISeason4>"
set.logicalDestination = "<UISeason4>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "Traditional_ChineseUISeason4 Game Data"
...
{
    _currentDirectory .. "WDC_pc_Traditional_ChineseUISeason4_compressed.ttarch2"
}
