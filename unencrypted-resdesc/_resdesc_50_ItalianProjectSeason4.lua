local set = {}
set.name = "ItalianProjectSeason4"
set.setName = "ItalianProjectSeason4"
set.descriptionFilenameOverride = ""
set.logicalName = "<ItalianProjectSeason4>"
...
set.gameDataName = "ItalianProjectSeason4 Game Data"
...
{
    _currentDirectory .. "WDC_pc_ItalianProjectSeason4_compressed.ttarch2"
}
