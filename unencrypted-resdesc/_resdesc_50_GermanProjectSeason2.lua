local set = {}
set.name = "GermanProjectSeason2"
set.setName = "GermanProjectSeason2"
set.descriptionFilenameOverride = ""
set.logicalName = "<GermanProjectSeason2>"
...
set.gameDataName = "GermanProjectSeason2 Game Data"
...
{
    _currentDirectory .. "WDC_pc_GermanProjectSeason2_compressed.ttarch2"
}
