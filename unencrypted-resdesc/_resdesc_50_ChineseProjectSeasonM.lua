local set = {}
set.name = "ChineseProjectSeasonM"
set.setName = "ChineseProjectSeasonM"
set.descriptionFilenameOverride = ""
set.logicalName = "<ChineseProjectSeasonM>"
...
set.gameDataName = "ChineseProjectSeasonM Game Data"
...
{
    _currentDirectory .. "WDC_pc_ChineseProjectSeasonM_compressed.ttarch2"
}
