local set = {}
set.name = "FrenchMenuSeason3"
set.setName = "FrenchMenuSeason3"
set.descriptionFilenameOverride = ""
set.logicalName = "<FrenchMenuSeason3>"
set.logicalDestination = "<MenuSeason3>"
set.priority = 1500
set.localDir = _currentDirectory
set.enableMode = "localization"
set.version = "trunk"
set.descriptionPriority = 0
set.gameDataName = "FrenchMenuSeason3 Game Data"
...
{
    _currentDirectory .. "WDC_pc_FrenchMenuSeason3_compressed.ttarch2"
}
