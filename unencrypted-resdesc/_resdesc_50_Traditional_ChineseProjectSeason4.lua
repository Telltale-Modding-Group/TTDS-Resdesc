local set = {}
set.name = "Traditional_ChineseProjectSeason4"
set.setName = "Traditional_ChineseProjectSeason4"
set.descriptionFilenameOverride = ""
set.logicalName = "<Traditional_ChineseProjectSeason4>"
...
set.gameDataName = "Traditional_ChineseProjectSeason4 Game Data"
...
{
    _currentDirectory .. "WDC_pc_Traditional_ChineseProjectSeason4_compressed.ttarch2"
}
