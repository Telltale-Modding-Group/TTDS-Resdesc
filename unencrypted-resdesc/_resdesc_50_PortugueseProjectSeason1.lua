local set = {}
set.name = "PortugueseProjectSeason1"
set.setName = "PortugueseProjectSeason1"
set.descriptionFilenameOverride = ""
set.logicalName = "<PortugueseProjectSeason1>"
...
set.gameDataName = "PortugueseProjectSeason1 Game Data"
...
{
    _currentDirectory .. "WDC_pc_PortugueseProjectSeason1_compressed.ttarch2"
}
